...
def mock_deepeval_metrics():
    ...
    with (
        patch("geneval.adapters.deepeval_adapter.AnswerRelevancyMetric") as mock_answer_relevancy,
...
class TestDeepEvalAdapter:
    ...
    def test_initialization_success_openai(self, mock_gpt_model):
        ...
        mock_llm_manager.get_deepeval_config.return_value = {"model": "gpt-4o-mini", "temperature": 0.1}
    ...
    def test_initialization_success_anthropic(self, mock_anthropic_model):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "claude-3-5-haiku", "temperature": 0.1}
    ...
    def test_initialization_success_amazon_bedrock(self, mock_bedrock_model):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "anthropic.claude-3-sonnet-20240229-v1:0", "temperature": 0.1}
    ...
    def test_initialization_success_gemini(self, mock_gemini_model):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "gemini-1.5-flash", "temperature": 0.1, "api_key": "test-key"}
    ...
    def test_initialization_success_deepseek(self, mock_deepseek_model):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "deepseek-chat", "temperature": 0.1, "api_key": "test-key"}
    ...
    def test_initialization_success_ollama(self, mock_ollama_model):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "llama3.2", "temperature": 0.1, "base_url": "http://localhost:11434"}
    ...
    def test_create_gpt_model_unknown_provider(self):
        ...
        mock_llm_manager.get_global_settings.return_value = {"temperature": 0.1}
        mock_llm_manager.get_deepeval_config.return_value = {"model": "unknown-model", "temperature": 0.1}

        with pytest.raises(
            ValueError,
            match="Provider unknown_provider not fully supported for DeepEval. Only OpenAI, Azure OpenAI, Anthropic, Amazon Bedrock, Gemini, DeepSeek, Ollama and VLLM providers are currently supported.",
        ):
            DeepEvalAdapter(mock_llm_manager)
    ...
    def test_evaluate_success(self, mock_gpt_model):
        ...
        adapter.available_metrics = {"faithfulness": mock_faithfulness_metric, "answer_relevancy": mock_answer_relevancy_metric}
    ...
    def test_evaluate_success_no_reason(self, mock_gpt_model):
        ...
        adapter.available_metrics = {"faithfulness": mock_faithfulness_metric}
    ...
    def test_supported_metrics_list(self, mock_gpt_model):
        ...
        expected_metrics = ["answer_relevancy", "context_relevance", "faithfulness", "context_recall", "context_precision"]
