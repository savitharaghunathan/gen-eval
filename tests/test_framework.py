...
from geneval.schemas import Output
...
class TestGenEvalFramework:
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_initialization_adapter_failure(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_initialization_deepeval_adapter_failure(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_single_metric_single_adapter(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_single_metric_multiple_adapters(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_specific_adapter_metric(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_multiple_metrics_mixed_format(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
        ...
        mock_ragas_adapter.evaluate.side_effect = [
            mock_ragas_faithfulness,
            mock_ragas_answer_relevancy,
        ]
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_unsupported_metric_for_adapter(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
        ...
        with pytest.raises(
            ValueError,
            match="Adapter 'ragas' does not support metric 'context_relevance'",
        ):
            framework.evaluate(
                question="What is the capital of France?",
                response="The capital of France is Paris.",
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_no_adapter_supports_metric(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_empty_metrics_list(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_with_complex_input_data(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_with_empty_strings(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_with_vllm_provider(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
    ...
    @patch("geneval.framework.DeepEvalAdapter")
    @patch("geneval.framework.LLMManager")
    def test_evaluate_with_none_values(
        self,
        mock_llm_manager_class,
        mock_deepeval_adapter_class,
        mock_ragas_adapter_class,
        ...
        with pytest.raises(ValueError):  # Should fail due to validation
            framework.evaluate(
                question=None,
                response=None,
