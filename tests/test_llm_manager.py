...
class TestLLMManager:
    ...
    def test_initialization_with_config(self, mock_load_config):
        ...
        mock_config = {
            "providers": {"openai": {"enabled": True, "default": True, "model": "gpt-4o-mini"}},
    ...
    def test_validate_config_single_default(self, mock_load_config):
        ...
        mock_config = {"providers": {"openai": {"enabled": True, "default": True, "model": "gpt-4o-mini"}}}
        mock_load_config.return_value = mock_config
    ...
    def test_get_api_key_deepseek(self, mock_load_config):
        ...
        mock_config = {"providers": {"deepseek": {"enabled": True, "default": True, "model": "deepseek-chat"}}}
        mock_load_config.return_value = mock_config
    ...
    def test_get_deepeval_config_deepseek(self, mock_load_config):
        ...
        mock_config = {
            "providers": {"deepseek": {"enabled": True, "default": True, "model": "deepseek-chat"}},
            "settings": {"temperature": 0.1},
        }
        mock_load_config.return_value = mock_config
    ...
    def test_get_deepeval_config_ollama_default_url(self, mock_load_config):
        ...
        mock_config = {
            "providers": {"ollama": {"enabled": True, "default": True, "model": "llama3.2"}},
            "settings": {"temperature": 0.1},
        }
        mock_load_config.return_value = mock_config
